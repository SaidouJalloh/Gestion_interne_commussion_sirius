...
type IncorporationsListProps = {
    contratId?: string | null;
};

type CreatedByProfile = { prenom?: string | null; nom?: string | null };
...
type IncorporationRow = {
    ...
    fga: number;
    taxes: number;
    montant_accessoire: number;
    created_by_profile?: CreatedByProfile | null;
};

export const IncorporationsList = ({ contratId }: IncorporationsListProps) => {
    const { incorporations, loading } = useIncorporations(contratId) as unknown as {
