...
export const EvolutionCharts = ({ graphiques }: { graphiques: any }) => {
    const maxClients = Math.max(
        ...graphiques.evolutionClients.map((e: any) => e.clients),
        1,
    );
        ...
        <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-slate-100 dark:border-gray-700 p-6">
                ...
                <div className="space-y-3">
                    {graphiques.evolutionClients.map((item: any, index: number) => (
                        <div key={index}>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-slate-100 dark:border-gray-700 p-6">
                ...
                <div className="space-y-3">
                    {graphiques.evolutionCommissions.map((item: any, index: number) => (
