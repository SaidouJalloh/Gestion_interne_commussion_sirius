...
export const FlotteModal = ({ contrat, onClose }) => {
    const { vehicules, loading, addVehicule, updateVehicule, deleteVehicule } = useVehicules(contrat?.id);
    const [activeTab, setActiveTab] = useState('vehicules'); // 👈 NOUVEAU STATE
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col animate-scale-in">
                ...
                <div className="bg-white border-b flex">
                    ...
                    >
                        ...
                        Incorporations
                        {contrat.nombre_incorporations > 0 && (
                        ...
                        <>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <div className="bg-white rounded-lg p-3 border border-blue-200">
                                        ...
                                        <p className="text-lg font-bold text-gray-900">
                                            {parseFloat(contrat.prime_ttc_initial || contrat.prime_ttc || 0).toLocaleString('fr-FR')} FCFA
                                        </p>
                                    </div>
                                    <div className="bg-white rounded-lg p-3 border border-green-200">
                                        <p className="text-xs text-gray-600 mb-1">Incorporations</p>
                                        <p className="text-lg font-bold text-green-600">
                                            +{parseFloat(contrat.montant_incorporations || 0).toLocaleString('fr-FR')} FCFA
                                        </p>
                                    </div>
                            ...
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <span className="text-sm text-gray-600">
                                    {contrat.nombre_incorporations || 0} incorporation{contrat.nombre_incorporations > 1 ? 's' : ''}
                                </span>
                            </div>
