...
// Spinner avec texte
export const SpinnerWithText = ({ text = 'Chargement...', size = 'md' }: { text?: string; size?: SpinnerSize }) => (
...
export const LoadingOverlay = ({ show, text = 'Chargement...' }: { show: boolean; text?: string }) => {
    if (!show) return null;
